...
#Botones
boton = tk.Button(text='Click',command=lambda: ventana.boton_aniadir(lbx_estudiantes,e_nombre,e_apellido,e_dni,e_domicilio,com_genero,com_anio,materias_disponibles))
...
#frame2
lbx_estudiantes = tk.Listbox(window)
lbx_estudiantes.grid(row=1,column=3, sticky='NSEW', rowspan=14, columnspan=4)
lbx_estudiantes.bind('<<ListboxSelect>>')
